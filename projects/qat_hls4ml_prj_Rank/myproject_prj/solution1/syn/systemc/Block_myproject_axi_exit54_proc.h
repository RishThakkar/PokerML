...
#ifndef _Block_myproject_axi_exit54_proc_HH_
#define _Block_myproject_axi_exit54_proc_HH_
...
struct Block_myproject_axi_exit54_proc : public sc_module {
    ...
    sc_in< sc_lv<16> > out_local_V_data_10_V_dout;
    sc_in< sc_logic > out_local_V_data_10_V_empty_n;
    sc_out< sc_logic > out_local_V_data_10_V_read;
    sc_in< sc_lv<16> > out_local_V_data_11_V_dout;
    sc_in< sc_logic > out_local_V_data_11_V_empty_n;
    sc_out< sc_logic > out_local_V_data_11_V_read;
    sc_in< sc_lv<16> > out_local_V_data_12_V_dout;
    sc_in< sc_logic > out_local_V_data_12_V_empty_n;
    sc_out< sc_logic > out_local_V_data_12_V_read;
    ...
    sc_out< sc_lv<16> > tmp_data_V_727;
    sc_out< sc_logic > tmp_data_V_727_ap_vld;
    ...
    sc_out< sc_lv<16> > tmp_data_V_10;
    sc_out< sc_logic > tmp_data_V_10_ap_vld;
    sc_out< sc_lv<16> > tmp_data_V_11;
    sc_out< sc_logic > tmp_data_V_11_ap_vld;
    sc_out< sc_lv<16> > tmp_data_V_12;
    sc_out< sc_logic > tmp_data_V_12_ap_vld;


    // Module declarations
    Block_myproject_axi_exit54_proc(sc_module_name name);
    SC_HAS_PROCESS(Block_myproject_axi_exit54_proc);
    ...
    sc_signal< sc_logic > out_local_V_data_10_V_blk_n;
    sc_signal< sc_logic > out_local_V_data_11_V_blk_n;
    sc_signal< sc_logic > out_local_V_data_12_V_blk_n;
    ...
    sc_signal< sc_lv<16> > tmp_data_V_727_preg;
    sc_signal< sc_lv<16> > tmp_data_V_8_preg;
    sc_signal< sc_lv<16> > tmp_data_V_9_preg;
    sc_signal< sc_lv<16> > tmp_data_V_10_preg;
    sc_signal< sc_lv<16> > tmp_data_V_11_preg;
    sc_signal< sc_lv<16> > tmp_data_V_12_preg;
    ...
    void thread_out_local_V_data_10_V_blk_n();
    void thread_out_local_V_data_10_V_read();
    void thread_out_local_V_data_11_V_blk_n();
    void thread_out_local_V_data_11_V_read();
    void thread_out_local_V_data_12_V_blk_n();
    void thread_out_local_V_data_12_V_read();
    ...
    void thread_tmp_data_V_10();
    void thread_tmp_data_V_10_ap_vld();
    void thread_tmp_data_V_11();
    void thread_tmp_data_V_11_ap_vld();
    void thread_tmp_data_V_12();
    void thread_tmp_data_V_12_ap_vld();
    ...
    void thread_tmp_data_V_727();
    void thread_tmp_data_V_727_ap_vld();
