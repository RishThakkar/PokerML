...
entity Block_myproject_axi_exit54_proc is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of Block_myproject_axi_exit54_proc is 
    ...
    signal out_local_V_data_10_V_blk_n : STD_LOGIC;
    signal out_local_V_data_11_V_blk_n : STD_LOGIC;
    signal out_local_V_data_12_V_blk_n : STD_LOGIC;
    ...
    signal tmp_data_V_3_preg : STD_LOGIC_VECTOR (15 downto 0) := "0000000000000000";
    ...
    signal tmp_data_V_727_preg : STD_LOGIC_VECTOR (15 downto 0) := "0000000000000000";
...
begin
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((ap_continue = ap_const_logic_1)) then 
                    ap_done_reg <= ap_const_logic_0;
                elsif ((not(((ap_start = ap_const_logic_0) or (io_acc_block_signal_op15 = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((not(((ap_start = ap_const_logic_0) or (io_acc_block_signal_op15 = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((not(((ap_start = ap_const_logic_0) or (io_acc_block_signal_op15 = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
                    tmp_data_V_10_preg <= out_local_V_data_10_V_dout;
                end if; 
            end if;
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((not(((ap_start = ap_const_logic_0) or (io_acc_block_signal_op15 = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
                    tmp_data_V_11_preg <= out_local_V_data_11_V_dout;
                end if; 
            end if;
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((not(((ap_start = ap_const_logic_0) or (io_acc_block_signal_op15 = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
                    tmp_data_V_12_preg <= out_local_V_data_12_V_dout;
                end if; 
            end if;
        end if;
    end process;
    ...
    tmp_data_V_727_preg_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((not(((ap_start = ap_const_logic_0) or (io_acc_block_signal_op15 = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
                    tmp_data_V_727_preg <= out_local_V_data_7_V_dout;
                end if; 
            end if;
        end if;
    end process;
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, io_acc_block_signal_op15)
    begin
        case ap_CS_fsm is
    ...
    ap_block_state1_assign_proc : process(ap_start, ap_done_reg, io_acc_block_signal_op15)
    begin
                ap_block_state1 <= ((ap_start = ap_const_logic_0) or (io_acc_block_signal_op15 = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1));
    end process;


    ap_done_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, io_acc_block_signal_op15)
    begin
        if ((not(((ap_start = ap_const_logic_0) or (io_acc_block_signal_op15 = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    ap_ready_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, io_acc_block_signal_op15)
    begin
        if ((not(((ap_start = ap_const_logic_0) or (io_acc_block_signal_op15 = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    io_acc_block_signal_op15 <= (out_local_V_data_9_V_empty_n and out_local_V_data_8_V_empty_n and out_local_V_data_7_V_empty_n and out_local_V_data_6_V_empty_n and out_local_V_data_5_V_empty_n and out_local_V_data_4_V_empty_n and out_local_V_data_3_V_empty_n and out_local_V_data_2_V_empty_n and out_local_V_data_1_V_empty_n and out_local_V_data_12_V_empty_n and out_local_V_data_11_V_empty_n and out_local_V_data_10_V_empty_n and out_local_V_data_0_V_empty_n);
    ...
    out_local_V_data_0_V_read_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, io_acc_block_signal_op15)
    begin
        if ((not(((ap_start = ap_const_logic_0) or (io_acc_block_signal_op15 = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    out_local_V_data_10_V_blk_n_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, out_local_V_data_10_V_empty_n)
    begin
        if ((not(((ap_start = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            out_local_V_data_10_V_blk_n <= out_local_V_data_10_V_empty_n;
        else 
    ...
    out_local_V_data_10_V_read_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, io_acc_block_signal_op15)
    begin
        if ((not(((ap_start = ap_const_logic_0) or (io_acc_block_signal_op15 = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    out_local_V_data_11_V_blk_n_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, out_local_V_data_11_V_empty_n)
    begin
        if ((not(((ap_start = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            out_local_V_data_11_V_blk_n <= out_local_V_data_11_V_empty_n;
        else 
    ...
    out_local_V_data_11_V_read_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, io_acc_block_signal_op15)
    begin
        if ((not(((ap_start = ap_const_logic_0) or (io_acc_block_signal_op15 = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    out_local_V_data_12_V_blk_n_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, out_local_V_data_12_V_empty_n)
    begin
        if ((not(((ap_start = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            out_local_V_data_12_V_blk_n <= out_local_V_data_12_V_empty_n;
        else 
    ...
    out_local_V_data_12_V_read_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, io_acc_block_signal_op15)
    begin
        if ((not(((ap_start = ap_const_logic_0) or (io_acc_block_signal_op15 = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    out_local_V_data_1_V_read_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, io_acc_block_signal_op15)
    begin
        if ((not(((ap_start = ap_const_logic_0) or (io_acc_block_signal_op15 = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    out_local_V_data_2_V_read_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, io_acc_block_signal_op15)
    begin
        if ((not(((ap_start = ap_const_logic_0) or (io_acc_block_signal_op15 = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    out_local_V_data_3_V_read_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, io_acc_block_signal_op15)
    begin
        if ((not(((ap_start = ap_const_logic_0) or (io_acc_block_signal_op15 = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    out_local_V_data_4_V_read_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, io_acc_block_signal_op15)
    begin
        if ((not(((ap_start = ap_const_logic_0) or (io_acc_block_signal_op15 = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    out_local_V_data_5_V_read_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, io_acc_block_signal_op15)
    begin
        if ((not(((ap_start = ap_const_logic_0) or (io_acc_block_signal_op15 = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    out_local_V_data_6_V_read_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, io_acc_block_signal_op15)
    begin
        if ((not(((ap_start = ap_const_logic_0) or (io_acc_block_signal_op15 = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    out_local_V_data_7_V_read_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, io_acc_block_signal_op15)
    begin
        if ((not(((ap_start = ap_const_logic_0) or (io_acc_block_signal_op15 = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    out_local_V_data_8_V_read_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, io_acc_block_signal_op15)
    begin
        if ((not(((ap_start = ap_const_logic_0) or (io_acc_block_signal_op15 = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    out_local_V_data_9_V_read_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, io_acc_block_signal_op15)
    begin
        if ((not(((ap_start = ap_const_logic_0) or (io_acc_block_signal_op15 = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    tmp_data_V_0_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, out_local_V_data_0_V_dout, io_acc_block_signal_op15, tmp_data_V_0_preg)
    begin
        if ((not(((ap_start = ap_const_logic_0) or (io_acc_block_signal_op15 = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    tmp_data_V_0_ap_vld_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, io_acc_block_signal_op15)
    begin
        if ((not(((ap_start = ap_const_logic_0) or (io_acc_block_signal_op15 = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    tmp_data_V_1_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, out_local_V_data_1_V_dout, io_acc_block_signal_op15, tmp_data_V_1_preg)
    begin
        if ((not(((ap_start = ap_const_logic_0) or (io_acc_block_signal_op15 = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    tmp_data_V_10_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, out_local_V_data_10_V_dout, io_acc_block_signal_op15, tmp_data_V_10_preg)
    begin
        if ((not(((ap_start = ap_const_logic_0) or (io_acc_block_signal_op15 = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            tmp_data_V_10 <= out_local_V_data_10_V_dout;
        else 
    ...
    tmp_data_V_10_ap_vld_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, io_acc_block_signal_op15)
    begin
        if ((not(((ap_start = ap_const_logic_0) or (io_acc_block_signal_op15 = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    tmp_data_V_11_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, out_local_V_data_11_V_dout, io_acc_block_signal_op15, tmp_data_V_11_preg)
    begin
        if ((not(((ap_start = ap_const_logic_0) or (io_acc_block_signal_op15 = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            tmp_data_V_11 <= out_local_V_data_11_V_dout;
        else 
    ...
    tmp_data_V_11_ap_vld_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, io_acc_block_signal_op15)
    begin
        if ((not(((ap_start = ap_const_logic_0) or (io_acc_block_signal_op15 = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    tmp_data_V_12_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, out_local_V_data_12_V_dout, io_acc_block_signal_op15, tmp_data_V_12_preg)
    begin
        if ((not(((ap_start = ap_const_logic_0) or (io_acc_block_signal_op15 = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            tmp_data_V_12 <= out_local_V_data_12_V_dout;
        else 
    ...
    tmp_data_V_12_ap_vld_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, io_acc_block_signal_op15)
    begin
        if ((not(((ap_start = ap_const_logic_0) or (io_acc_block_signal_op15 = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    tmp_data_V_1_ap_vld_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, io_acc_block_signal_op15)
    begin
        if ((not(((ap_start = ap_const_logic_0) or (io_acc_block_signal_op15 = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    tmp_data_V_2_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, out_local_V_data_2_V_dout, io_acc_block_signal_op15, tmp_data_V_2_preg)
    begin
        if ((not(((ap_start = ap_const_logic_0) or (io_acc_block_signal_op15 = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    tmp_data_V_2_ap_vld_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, io_acc_block_signal_op15)
    begin
        if ((not(((ap_start = ap_const_logic_0) or (io_acc_block_signal_op15 = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    tmp_data_V_3_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, out_local_V_data_3_V_dout, io_acc_block_signal_op15, tmp_data_V_3_preg)
    begin
        if ((not(((ap_start = ap_const_logic_0) or (io_acc_block_signal_op15 = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    tmp_data_V_3_ap_vld_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, io_acc_block_signal_op15)
    begin
        if ((not(((ap_start = ap_const_logic_0) or (io_acc_block_signal_op15 = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    tmp_data_V_4_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, out_local_V_data_4_V_dout, io_acc_block_signal_op15, tmp_data_V_4_preg)
    begin
        if ((not(((ap_start = ap_const_logic_0) or (io_acc_block_signal_op15 = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    tmp_data_V_4_ap_vld_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, io_acc_block_signal_op15)
    begin
        if ((not(((ap_start = ap_const_logic_0) or (io_acc_block_signal_op15 = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    tmp_data_V_5_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, out_local_V_data_5_V_dout, io_acc_block_signal_op15, tmp_data_V_5_preg)
    begin
        if ((not(((ap_start = ap_const_logic_0) or (io_acc_block_signal_op15 = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    tmp_data_V_5_ap_vld_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, io_acc_block_signal_op15)
    begin
        if ((not(((ap_start = ap_const_logic_0) or (io_acc_block_signal_op15 = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    tmp_data_V_6_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, out_local_V_data_6_V_dout, io_acc_block_signal_op15, tmp_data_V_6_preg)
    begin
        if ((not(((ap_start = ap_const_logic_0) or (io_acc_block_signal_op15 = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    tmp_data_V_6_ap_vld_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, io_acc_block_signal_op15)
    begin
        if ((not(((ap_start = ap_const_logic_0) or (io_acc_block_signal_op15 = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    tmp_data_V_727_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, out_local_V_data_7_V_dout, io_acc_block_signal_op15, tmp_data_V_727_preg)
    begin
        if ((not(((ap_start = ap_const_logic_0) or (io_acc_block_signal_op15 = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            tmp_data_V_727 <= out_local_V_data_7_V_dout;
        else 
            tmp_data_V_727 <= tmp_data_V_727_preg;
        end if; 
    end process;


    tmp_data_V_727_ap_vld_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, io_acc_block_signal_op15)
    begin
        if ((not(((ap_start = ap_const_logic_0) or (io_acc_block_signal_op15 = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    tmp_data_V_8_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, out_local_V_data_8_V_dout, io_acc_block_signal_op15, tmp_data_V_8_preg)
    begin
        if ((not(((ap_start = ap_const_logic_0) or (io_acc_block_signal_op15 = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    tmp_data_V_8_ap_vld_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, io_acc_block_signal_op15)
    begin
        if ((not(((ap_start = ap_const_logic_0) or (io_acc_block_signal_op15 = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    tmp_data_V_9_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, out_local_V_data_9_V_dout, io_acc_block_signal_op15, tmp_data_V_9_preg)
    begin
        if ((not(((ap_start = ap_const_logic_0) or (io_acc_block_signal_op15 = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    tmp_data_V_9_ap_vld_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, io_acc_block_signal_op15)
    begin
        if ((not(((ap_start = ap_const_logic_0) or (io_acc_block_signal_op15 = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
