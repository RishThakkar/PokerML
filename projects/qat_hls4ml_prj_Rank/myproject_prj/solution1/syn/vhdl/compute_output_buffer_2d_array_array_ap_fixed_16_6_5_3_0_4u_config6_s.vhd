...
architecture behav of compute_output_buffer_2d_array_array_ap_fixed_16_6_5_3_0_4u_config6_s is 
    ...
    signal tmp_89_fu_878_p4 : STD_LOGIC_VECTOR (30 downto 0);
    signal tmp_90_fu_898_p4 : STD_LOGIC_VECTOR (30 downto 0);
...
begin
    ...
    icmp_ln289_2_fu_888_p2 <= "1" when (signed(tmp_89_fu_878_p4) > signed(ap_const_lv31_0)) else "0";
    icmp_ln289_3_fu_908_p2 <= "1" when (signed(tmp_90_fu_898_p4) > signed(ap_const_lv31_0)) else "0";
    ...
    select_ln328_fu_973_p3 <= 
        ...
        add_ln328_fu_968_p2;
    tmp_89_fu_878_p4 <= pY_2(31 downto 1);
    tmp_90_fu_898_p4 <= pX_2(31 downto 1);
end behav;
