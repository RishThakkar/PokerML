...
set C_modelArgList {
	...
	{ tmp_data_V_727 int 16 regular {pointer 0}  }
	{ tmp_data_V_8 int 16 regular {pointer 0}  }
	{ tmp_data_V_9 int 16 regular {pointer 0}  }
	{ tmp_data_V_10 int 16 regular {pointer 0}  }
	{ tmp_data_V_11 int 16 regular {pointer 0}  }
	{ tmp_data_V_12 int 16 regular {pointer 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "out_data", "interface" : "axis", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	...
 	{ "Name" : "tmp_data_V_727", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "tmp_data_V_10", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY"} , 
 	{ "Name" : "tmp_data_V_11", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY"} , 
 	{ "Name" : "tmp_data_V_12", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ tmp_data_V_727 sc_in sc_lv 16 signal 10 } 
	{ tmp_data_V_8 sc_in sc_lv 16 signal 11 } 
	{ tmp_data_V_9 sc_in sc_lv 16 signal 12 } 
	{ tmp_data_V_10 sc_in sc_lv 16 signal 13 } 
	{ tmp_data_V_11 sc_in sc_lv 16 signal 14 } 
	{ tmp_data_V_12 sc_in sc_lv 16 signal 15 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "tmp_data_V_727", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "tmp_data_V_727", "role": "default" }} , 
 	...
 	{ "name": "tmp_data_V_10", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "tmp_data_V_10", "role": "default" }} , 
 	{ "name": "tmp_data_V_11", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "tmp_data_V_11", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3"],
		...
		"Port" : [
			...
			{"Name" : "tmp_data_V_727", "Type" : "None", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0"},
...
set Spec2ImplPortList { 
	...
	tmp_data_V_727 { ap_none {  { tmp_data_V_727 in_data 0 16 } } }
	tmp_data_V_8 { ap_none {  { tmp_data_V_8 in_data 0 16 } } }
	tmp_data_V_9 { ap_none {  { tmp_data_V_9 in_data 0 16 } } }
	tmp_data_V_10 { ap_none {  { tmp_data_V_10 in_data 0 16 } } }
	tmp_data_V_11 { ap_none {  { tmp_data_V_11 in_data 0 16 } } }
	tmp_data_V_12 { ap_none {  { tmp_data_V_12 in_data 0 16 } } }
}
