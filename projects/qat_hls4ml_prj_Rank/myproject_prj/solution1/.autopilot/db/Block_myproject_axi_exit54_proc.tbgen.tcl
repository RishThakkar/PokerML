set moduleName Block_myproject_axi_exit54_proc
set isTopModule 0
...
set C_modelName {Block_myproject_axi_.exit54_proc}
...
set C_modelArgList {
	...
	{ out_local_V_data_10_V int 16 regular {fifo 0 volatile }  }
	{ out_local_V_data_11_V int 16 regular {fifo 0 volatile }  }
	{ out_local_V_data_12_V int 16 regular {fifo 0 volatile }  }
	...
	{ tmp_data_V_727 int 16 regular {pointer 1}  }
	{ tmp_data_V_8 int 16 regular {pointer 1}  }
	{ tmp_data_V_9 int 16 regular {pointer 1}  }
	{ tmp_data_V_10 int 16 regular {pointer 1}  }
	{ tmp_data_V_11 int 16 regular {pointer 1}  }
	{ tmp_data_V_12 int 16 regular {pointer 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "out_local_V_data_0_V", "interface" : "fifo", "bitwidth" : 16, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "out_local_V_data_10_V", "interface" : "fifo", "bitwidth" : 16, "direction" : "READONLY"} , 
 	{ "Name" : "out_local_V_data_11_V", "interface" : "fifo", "bitwidth" : 16, "direction" : "READONLY"} , 
 	{ "Name" : "out_local_V_data_12_V", "interface" : "fifo", "bitwidth" : 16, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "tmp_data_V_727", "interface" : "wire", "bitwidth" : 16, "direction" : "WRITEONLY"} , 
 	...
 	{ "Name" : "tmp_data_V_10", "interface" : "wire", "bitwidth" : 16, "direction" : "WRITEONLY"} , 
 	{ "Name" : "tmp_data_V_11", "interface" : "wire", "bitwidth" : 16, "direction" : "WRITEONLY"} , 
 	{ "Name" : "tmp_data_V_12", "interface" : "wire", "bitwidth" : 16, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ out_local_V_data_10_V_dout sc_in sc_lv 16 signal 10 } 
	{ out_local_V_data_10_V_empty_n sc_in sc_logic 1 signal 10 } 
	{ out_local_V_data_10_V_read sc_out sc_logic 1 signal 10 } 
	{ out_local_V_data_11_V_dout sc_in sc_lv 16 signal 11 } 
	{ out_local_V_data_11_V_empty_n sc_in sc_logic 1 signal 11 } 
	{ out_local_V_data_11_V_read sc_out sc_logic 1 signal 11 } 
	{ out_local_V_data_12_V_dout sc_in sc_lv 16 signal 12 } 
	{ out_local_V_data_12_V_empty_n sc_in sc_logic 1 signal 12 } 
	{ out_local_V_data_12_V_read sc_out sc_logic 1 signal 12 } 
	{ tmp_data_V_0 sc_out sc_lv 16 signal 13 } 
	{ tmp_data_V_0_ap_vld sc_out sc_logic 1 outvld 13 } 
	{ tmp_data_V_1 sc_out sc_lv 16 signal 14 } 
	{ tmp_data_V_1_ap_vld sc_out sc_logic 1 outvld 14 } 
	{ tmp_data_V_2 sc_out sc_lv 16 signal 15 } 
	{ tmp_data_V_2_ap_vld sc_out sc_logic 1 outvld 15 } 
	{ tmp_data_V_3 sc_out sc_lv 16 signal 16 } 
	{ tmp_data_V_3_ap_vld sc_out sc_logic 1 outvld 16 } 
	{ tmp_data_V_4 sc_out sc_lv 16 signal 17 } 
	{ tmp_data_V_4_ap_vld sc_out sc_logic 1 outvld 17 } 
	{ tmp_data_V_5 sc_out sc_lv 16 signal 18 } 
	{ tmp_data_V_5_ap_vld sc_out sc_logic 1 outvld 18 } 
	{ tmp_data_V_6 sc_out sc_lv 16 signal 19 } 
	{ tmp_data_V_6_ap_vld sc_out sc_logic 1 outvld 19 } 
	{ tmp_data_V_727 sc_out sc_lv 16 signal 20 } 
	{ tmp_data_V_727_ap_vld sc_out sc_logic 1 outvld 20 } 
	{ tmp_data_V_8 sc_out sc_lv 16 signal 21 } 
	{ tmp_data_V_8_ap_vld sc_out sc_logic 1 outvld 21 } 
	{ tmp_data_V_9 sc_out sc_lv 16 signal 22 } 
	{ tmp_data_V_9_ap_vld sc_out sc_logic 1 outvld 22 } 
	{ tmp_data_V_10 sc_out sc_lv 16 signal 23 } 
	{ tmp_data_V_10_ap_vld sc_out sc_logic 1 outvld 23 } 
	{ tmp_data_V_11 sc_out sc_lv 16 signal 24 } 
	{ tmp_data_V_11_ap_vld sc_out sc_logic 1 outvld 24 } 
	{ tmp_data_V_12 sc_out sc_lv 16 signal 25 } 
	{ tmp_data_V_12_ap_vld sc_out sc_logic 1 outvld 25 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "out_local_V_data_10_V_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "out_local_V_data_10_V", "role": "dout" }} , 
 	{ "name": "out_local_V_data_10_V_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "out_local_V_data_10_V", "role": "empty_n" }} , 
 	{ "name": "out_local_V_data_10_V_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "out_local_V_data_10_V", "role": "read" }} , 
 	{ "name": "out_local_V_data_11_V_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "out_local_V_data_11_V", "role": "dout" }} , 
 	{ "name": "out_local_V_data_11_V_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "out_local_V_data_11_V", "role": "empty_n" }} , 
 	{ "name": "out_local_V_data_11_V_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "out_local_V_data_11_V", "role": "read" }} , 
 	{ "name": "out_local_V_data_12_V_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "out_local_V_data_12_V", "role": "dout" }} , 
 	{ "name": "out_local_V_data_12_V_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "out_local_V_data_12_V", "role": "empty_n" }} , 
 	{ "name": "out_local_V_data_12_V_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "out_local_V_data_12_V", "role": "read" }} , 
 	...
 	{ "name": "tmp_data_V_727", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "tmp_data_V_727", "role": "default" }} , 
 	{ "name": "tmp_data_V_727_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "tmp_data_V_727", "role": "ap_vld" }} , 
 	...
 	{ "name": "tmp_data_V_10", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "tmp_data_V_10", "role": "default" }} , 
 	{ "name": "tmp_data_V_10_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "tmp_data_V_10", "role": "ap_vld" }} , 
 	{ "name": "tmp_data_V_11", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "tmp_data_V_11", "role": "default" }} , 
 	{ "name": "tmp_data_V_11_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "tmp_data_V_11", "role": "ap_vld" }} , 
 	{ "name": "tmp_data_V_12", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "tmp_data_V_12", "role": "default" }} , 
 	{ "name": "tmp_data_V_12_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "tmp_data_V_12", "role": "ap_vld" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			...
			{"Name" : "out_local_V_data_10_V", "Type" : "Fifo", "Direction" : "I",
				"BlockSignal" : [
					{"Name" : "out_local_V_data_10_V_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "out_local_V_data_11_V", "Type" : "Fifo", "Direction" : "I",
				"BlockSignal" : [
					{"Name" : "out_local_V_data_11_V_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "out_local_V_data_12_V", "Type" : "Fifo", "Direction" : "I",
				"BlockSignal" : [
			...
			{"Name" : "tmp_data_V_727", "Type" : "Vld", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0"},
			...
			{"Name" : "tmp_data_V_10", "Type" : "Vld", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0"},
			{"Name" : "tmp_data_V_11", "Type" : "Vld", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0"},
			{"Name" : "tmp_data_V_12", "Type" : "Vld", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0"}]}]}
...
set Spec2ImplPortList { 
	...
	out_local_V_data_10_V { ap_fifo {  { out_local_V_data_10_V_dout fifo_data 0 16 }  { out_local_V_data_10_V_empty_n fifo_status 0 1 }  { out_local_V_data_10_V_read fifo_update 1 1 } } }
	out_local_V_data_11_V { ap_fifo {  { out_local_V_data_11_V_dout fifo_data 0 16 }  { out_local_V_data_11_V_empty_n fifo_status 0 1 }  { out_local_V_data_11_V_read fifo_update 1 1 } } }
	out_local_V_data_12_V { ap_fifo {  { out_local_V_data_12_V_dout fifo_data 0 16 }  { out_local_V_data_12_V_empty_n fifo_status 0 1 }  { out_local_V_data_12_V_read fifo_update 1 1 } } }
	...
	tmp_data_V_727 { ap_vld {  { tmp_data_V_727 out_data 1 16 }  { tmp_data_V_727_ap_vld out_vld 1 1 } } }
	...
	tmp_data_V_10 { ap_vld {  { tmp_data_V_10 out_data 1 16 }  { tmp_data_V_10_ap_vld out_vld 1 1 } } }
	tmp_data_V_11 { ap_vld {  { tmp_data_V_11 out_data 1 16 }  { tmp_data_V_11_ap_vld out_vld 1 1 } } }
	tmp_data_V_12 { ap_vld {  { tmp_data_V_12 out_data 1 16 }  { tmp_data_V_12_ap_vld out_vld 1 1 } } }
}
