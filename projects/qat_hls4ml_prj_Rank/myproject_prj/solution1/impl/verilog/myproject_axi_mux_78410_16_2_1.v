...
module myproject_axi_mux_78410_16_2_1 #(
parameter
    ID                = 0,
    NUM_STAGE         = 1,
    din0_WIDTH       = 32,
...
reg  [15 : 0]         mux_5_4_reg;
reg  [15 : 0]         mux_5_5_reg;
reg  [15 : 0]         mux_5_6_reg;
reg  [15 : 0]         mux_5_7_reg;
reg  [15 : 0]         mux_5_8_reg;
reg  [15 : 0]         mux_5_9_reg;
reg  [15 : 0]         mux_5_10_reg;
reg  [15 : 0]         mux_5_11_reg;
reg  [15 : 0]         mux_5_12_reg;
reg  [15 : 0]         mux_5_13_reg;
reg  [15 : 0]         mux_5_14_reg;
reg  [15 : 0]         mux_5_15_reg;
reg  [15 : 0]         mux_5_16_reg;
reg  [15 : 0]         mux_5_17_reg;
reg  [15 : 0]         mux_5_18_reg;
reg  [15 : 0]         mux_5_19_reg;
reg  [15 : 0]         mux_5_20_reg;
reg  [15 : 0]         mux_5_21_reg;
reg  [15 : 0]         mux_5_22_reg;
reg  [15 : 0]         mux_5_23_reg;
reg  [15 : 0]         mux_5_24_reg;
reg  [9 : 5]      sel5;
// level 6 signals
wire [15 : 0]         mux_6_0;
wire [15 : 0]         mux_6_1;
...
always @(posedge clk) begin
    if (reset == 1)
        ...
        if (sel[4] == 0)
            mux_5_5_reg <= mux_4_10;
        else
            mux_5_5_reg <= mux_4_11;
    end
end
...
always @(posedge clk) begin
    if (reset == 1)
        ...
        if (sel[4] == 0)
            mux_5_6_reg <= mux_4_12;
        else
            mux_5_6_reg <= mux_4_13;
    end
end
...
always @(posedge clk) begin
    if (reset == 1)
        ...
        if (sel[4] == 0)
            mux_5_7_reg <= mux_4_14;
        else
            mux_5_7_reg <= mux_4_15;
    end
end
...
always @(posedge clk) begin
    if (reset == 1)
        ...
        if (sel[4] == 0)
            mux_5_8_reg <= mux_4_16;
        else
            mux_5_8_reg <= mux_4_17;
    end
end
...
always @(posedge clk) begin
    if (reset == 1)
        ...
        if (sel[4] == 0)
            mux_5_9_reg <= mux_4_18;
        else
            mux_5_9_reg <= mux_4_19;
    end
end
...
always @(posedge clk) begin
    if (reset == 1)
        ...
        if (sel[4] == 0)
            mux_5_10_reg <= mux_4_20;
        else
            mux_5_10_reg <= mux_4_21;
    end
end
...
always @(posedge clk) begin
    if (reset == 1)
        ...
        if (sel[4] == 0)
            mux_5_11_reg <= mux_4_22;
        else
            mux_5_11_reg <= mux_4_23;
    end
end
...
always @(posedge clk) begin
    if (reset == 1)
        ...
        if (sel[4] == 0)
            mux_5_12_reg <= mux_4_24;
        else
            mux_5_12_reg <= mux_4_25;
    end
end
...
always @(posedge clk) begin
    if (reset == 1)
        ...
        if (sel[4] == 0)
            mux_5_13_reg <= mux_4_26;
        else
            mux_5_13_reg <= mux_4_27;
    end
end
...
always @(posedge clk) begin
    if (reset == 1)
        ...
        if (sel[4] == 0)
            mux_5_14_reg <= mux_4_28;
        else
            mux_5_14_reg <= mux_4_29;
    end
end
...
always @(posedge clk) begin
    if (reset == 1)
        ...
        if (sel[4] == 0)
            mux_5_15_reg <= mux_4_30;
        else
            mux_5_15_reg <= mux_4_31;
    end
end
...
always @(posedge clk) begin
    if (reset == 1)
        ...
        if (sel[4] == 0)
            mux_5_16_reg <= mux_4_32;
        else
            mux_5_16_reg <= mux_4_33;
    end
end
...
always @(posedge clk) begin
    if (reset == 1)
        ...
        if (sel[4] == 0)
            mux_5_17_reg <= mux_4_34;
        else
            mux_5_17_reg <= mux_4_35;
    end
end
...
always @(posedge clk) begin
    if (reset == 1)
        ...
        if (sel[4] == 0)
            mux_5_18_reg <= mux_4_36;
        else
            mux_5_18_reg <= mux_4_37;
    end
end
...
always @(posedge clk) begin
    if (reset == 1)
        ...
        if (sel[4] == 0)
            mux_5_19_reg <= mux_4_38;
        else
            mux_5_19_reg <= mux_4_39;
    end
end
...
always @(posedge clk) begin
    if (reset == 1)
        ...
        if (sel[4] == 0)
            mux_5_20_reg <= mux_4_40;
        else
            mux_5_20_reg <= mux_4_41;
    end
end
...
always @(posedge clk) begin
    if (reset == 1)
        ...
        if (sel[4] == 0)
            mux_5_21_reg <= mux_4_42;
        else
            mux_5_21_reg <= mux_4_43;
    end
end
...
always @(posedge clk) begin
    if (reset == 1)
        ...
        if (sel[4] == 0)
            mux_5_22_reg <= mux_4_44;
        else
            mux_5_22_reg <= mux_4_45;
    end
end
...
always @(posedge clk) begin
    if (reset == 1)
        ...
        if (sel[4] == 0)
            mux_5_23_reg <= mux_4_46;
        else
            mux_5_23_reg <= mux_4_47;
    end
end
...
assign mux_6_1 = (sel5[5] == 0)? mux_5_2_reg : mux_5_3_reg;
assign mux_6_2 = (sel5[5] == 0)? mux_5_4_reg : mux_5_5_reg;
assign mux_6_3 = (sel5[5] == 0)? mux_5_6_reg : mux_5_7_reg;
assign mux_6_4 = (sel5[5] == 0)? mux_5_8_reg : mux_5_9_reg;
assign mux_6_5 = (sel5[5] == 0)? mux_5_10_reg : mux_5_11_reg;
assign mux_6_6 = (sel5[5] == 0)? mux_5_12_reg : mux_5_13_reg;
assign mux_6_7 = (sel5[5] == 0)? mux_5_14_reg : mux_5_15_reg;
assign mux_6_8 = (sel5[5] == 0)? mux_5_16_reg : mux_5_17_reg;
assign mux_6_9 = (sel5[5] == 0)? mux_5_18_reg : mux_5_19_reg;
assign mux_6_10 = (sel5[5] == 0)? mux_5_20_reg : mux_5_21_reg;
assign mux_6_11 = (sel5[5] == 0)? mux_5_22_reg : mux_5_23_reg;
assign mux_6_12 = mux_5_24_reg;

// Generate level 7 logic
assign mux_7_0 = (sel5[6] == 0)? mux_6_0 : mux_6_1;
assign mux_7_1 = (sel5[6] == 0)? mux_6_2 : mux_6_3;
assign mux_7_2 = (sel5[6] == 0)? mux_6_4 : mux_6_5;
assign mux_7_3 = (sel5[6] == 0)? mux_6_6 : mux_6_7;
assign mux_7_4 = (sel5[6] == 0)? mux_6_8 : mux_6_9;
assign mux_7_5 = (sel5[6] == 0)? mux_6_10 : mux_6_11;
assign mux_7_6 = mux_6_12;

// Generate level 8 logic
assign mux_8_0 = (sel5[7] == 0)? mux_7_0 : mux_7_1;
assign mux_8_1 = (sel5[7] == 0)? mux_7_2 : mux_7_3;
assign mux_8_2 = (sel5[7] == 0)? mux_7_4 : mux_7_5;
assign mux_8_3 = mux_7_6;

// Generate level 9 logic
assign mux_9_0 = (sel5[8] == 0)? mux_8_0 : mux_8_1;
assign mux_9_1 = (sel5[8] == 0)? mux_8_2 : mux_8_3;

// Generate level 10 logic
assign mux_10_0 = (sel5[9] == 0)? mux_9_0 : mux_9_1;
