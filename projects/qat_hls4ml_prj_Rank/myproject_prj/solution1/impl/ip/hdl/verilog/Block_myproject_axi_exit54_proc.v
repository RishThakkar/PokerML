...
module Block_myproject_axi_exit54_proc (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
        ...
        out_local_V_data_10_V_dout,
        out_local_V_data_10_V_empty_n,
        out_local_V_data_10_V_read,
        out_local_V_data_11_V_dout,
        out_local_V_data_11_V_empty_n,
        out_local_V_data_11_V_read,
        out_local_V_data_12_V_dout,
        out_local_V_data_12_V_empty_n,
        out_local_V_data_12_V_read,
        tmp_data_V_0,
        tmp_data_V_0_ap_vld,
        tmp_data_V_1,
        tmp_data_V_1_ap_vld,
...
input  [15:0] out_local_V_data_10_V_dout;
input   out_local_V_data_10_V_empty_n;
output   out_local_V_data_10_V_read;
input  [15:0] out_local_V_data_11_V_dout;
input   out_local_V_data_11_V_empty_n;
output   out_local_V_data_11_V_read;
input  [15:0] out_local_V_data_12_V_dout;
input   out_local_V_data_12_V_empty_n;
output   out_local_V_data_12_V_read;
...
output  [15:0] tmp_data_V_727;
output   tmp_data_V_727_ap_vld;
...
reg out_local_V_data_10_V_read;
reg out_local_V_data_11_V_read;
reg out_local_V_data_12_V_read;
...
reg[15:0] tmp_data_V_727;
reg tmp_data_V_727_ap_vld;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if ((~((ap_start == 1'b0) | (io_acc_block_signal_op15 == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((~((ap_start == 1'b0) | (io_acc_block_signal_op15 == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if ((~((ap_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        ...
        out_local_V_data_10_V_blk_n = 1'b1;
    end
end

always @ (*) begin
    if ((~((ap_start == 1'b0) | (io_acc_block_signal_op15 == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        out_local_V_data_10_V_read = 1'b1;
    end else begin
        out_local_V_data_10_V_read = 1'b0;
    end
end
...
always @ (*) begin
    if ((~((ap_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        ...
        out_local_V_data_11_V_blk_n = 1'b1;
    end
end

always @ (*) begin
    if ((~((ap_start == 1'b0) | (io_acc_block_signal_op15 == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        out_local_V_data_11_V_read = 1'b1;
    end else begin
        out_local_V_data_11_V_read = 1'b0;
    end
end
...
always @ (*) begin
    if ((~((ap_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        ...
        out_local_V_data_12_V_blk_n = 1'b1;
    end
end

always @ (*) begin
    if ((~((ap_start == 1'b0) | (io_acc_block_signal_op15 == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        out_local_V_data_12_V_read = 1'b1;
    end else begin
        out_local_V_data_12_V_read = 1'b0;
    end
end
...
always @ (*) begin
    if ((~((ap_start == 1'b0) | (io_acc_block_signal_op15 == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        tmp_data_V_727_ap_vld = 1'b1;
    end else begin
        tmp_data_V_727_ap_vld = 1'b0;
    end
end
