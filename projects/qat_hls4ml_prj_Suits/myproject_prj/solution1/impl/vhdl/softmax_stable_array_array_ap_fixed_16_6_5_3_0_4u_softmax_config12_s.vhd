...
entity softmax_stable_array_array_ap_fixed_16_6_5_3_0_4u_softmax_config12_s is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of softmax_stable_array_array_ap_fixed_16_6_5_3_0_4u_softmax_config12_s is 
    ...
    component softmax_stable_array_array_ap_fixed_16_6_5_3_0_4u_softmax_config12_s_exp_table1 IS
    generic (
        DataWidth : INTEGER;
    ...
    component softmax_stable_array_array_ap_fixed_16_6_5_3_0_4u_softmax_config12_s_invert_txdS IS
    generic (
        DataWidth : INTEGER;
        AddressRange : INTEGER;
        AddressWidth : INTEGER );
...
begin
    exp_table1_U : component softmax_stable_array_array_ap_fixed_16_6_5_3_0_4u_softmax_config12_s_exp_table1
    generic map (
        DataWidth => 17,
        AddressRange => 1024,
        AddressWidth => 10)
    ...
    invert_table2_U : component softmax_stable_array_array_ap_fixed_16_6_5_3_0_4u_softmax_config12_s_invert_txdS
    generic map (
        DataWidth => 18,
        AddressRange => 1024,
        AddressWidth => 10)
