...
entity softmax_stable_exEe0_rom is 
    generic(
             DWIDTH     : integer := 17; 
             AWIDTH     : integer := 10; 
...
architecture rtl of softmax_stable_exEe0_rom is 
...
entity softmax_stable_exEe0 is
    generic (
...
architecture arch of softmax_stable_exEe0 is
    component softmax_stable_exEe0_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    softmax_stable_exEe0_rom_U :  component softmax_stable_exEe0_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
