...
if { $list_projs eq "" } {
   create_project project_1 myproj -part xczu5ev-sfvc784-2LV-e
}
...
proc create_root_design { parentCell } {
  ...
  set out_r [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:axis_rtl:1.0 out_r ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {200000000.0} \
   ] $out_r
  ...
  # Create ports
  set ap_clk [ create_bd_port -dir I -type clk -freq_hz 200000000.0 ap_clk ]
  set ap_rst_n [ create_bd_port -dir I -type rst ap_rst_n ]

  # Create instance: hls_inst, and set properties
  set hls_inst [ create_bd_cell -type ip -vlnv xilinx.com:hls:myproject_axi:1.0 hls_inst ]
