...
entity dense_resource_1_jbC_rom is 
    generic(
             DWIDTH     : integer := 6; 
             AWIDTH     : integer := 7; 
...
architecture rtl of dense_resource_1_jbC_rom is 
...
entity dense_resource_1_jbC is
    generic (
        DataWidth : INTEGER := 6;
...
architecture arch of dense_resource_1_jbC is
    component dense_resource_1_jbC_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    dense_resource_1_jbC_rom_U :  component dense_resource_1_jbC_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
