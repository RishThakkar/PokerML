...
#ifndef _Block_myproject_axi_exit44_proc_HH_
#define _Block_myproject_axi_exit44_proc_HH_
...
struct Block_myproject_axi_exit44_proc : public sc_module {
    ...
    // Module declarations
    Block_myproject_axi_exit44_proc(sc_module_name name);
    SC_HAS_PROCESS(Block_myproject_axi_exit44_proc);
