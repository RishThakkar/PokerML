...
// ==============================================================
#ifndef __myproject_axi_mullbW__HH__
#define __myproject_axi_mullbW__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(myproject_axi_mullbW) {
    ...
    SC_CTOR(myproject_axi_mullbW):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
