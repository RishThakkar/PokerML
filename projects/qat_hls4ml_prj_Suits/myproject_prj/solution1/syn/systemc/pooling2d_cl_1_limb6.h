...
#ifndef _pooling2d_cl_1_limb6_H_
#define _pooling2d_cl_1_limb6_H_
#include <systemc>
#include <iostream>
#include <fstream>
#include "AESL_pkg.h"
...
struct pooling2d_cl_1_limb6_core : public sc_core::sc_module
{
public:
    ...
    SC_HAS_PROCESS(pooling2d_cl_1_limb6_core);
    pooling2d_cl_1_limb6_core(sc_core::sc_module_name) {
        SC_METHOD(proc_dout);
...
SC_MODULE( pooling2d_cl_1_limb6 )
{
    ...
    SC_CTOR( pooling2d_cl_1_limb6 ) {
        meminst = new pooling2d_cl_1_limb6_core <DataWidth, AddressWidth, AddressRange>("core_inst");
    ...
    ~pooling2d_cl_1_limb6() {
        delete meminst;
    }

public:
    pooling2d_cl_1_limb6_core <DataWidth, AddressWidth, AddressRange>* meminst;

};

#endif //_pooling2d_cl_1_limb6_H_
