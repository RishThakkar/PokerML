...
// ==============================================================
#ifndef __myproject_axi_fpebkb__HH__
#define __myproject_axi_fpebkb__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(myproject_axi_fpebkb) {
    ...
    SC_CTOR(myproject_axi_fpebkb):  ACMP_fpext_U ("ACMP_fpext_U") {
