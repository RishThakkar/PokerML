...
#ifndef _softmax_stable_HH_
#define _softmax_stable_HH_

#include "systemc.h"
#include "AESL_pkg.h"

#include "softmax_stable_exEe0.h"
#include "softmax_stable_inFfa.h"

namespace ap_rtl {

struct softmax_stable : public sc_module {
    ...
    // Module declarations
    softmax_stable(sc_module_name name);
    SC_HAS_PROCESS(softmax_stable);

    ~softmax_stable();

    sc_trace_file* mVcdFile;

    softmax_stable_exEe0* exp_table1_U;
    softmax_stable_inFfa* invert_table2_U;
