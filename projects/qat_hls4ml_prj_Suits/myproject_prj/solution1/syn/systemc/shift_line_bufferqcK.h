...
#ifndef _shift_line_bufferqcK_H_
#define _shift_line_bufferqcK_H_
#include <systemc>
#include <iostream>
#include <fstream>
#include "AESL_pkg.h"
...
struct shift_line_bufferqcK_core : public sc_core::sc_module
{
public:
    ...
    SC_HAS_PROCESS(shift_line_bufferqcK_core);
    shift_line_bufferqcK_core(sc_core::sc_module_name) {
        SC_METHOD(proc_dout);
...
SC_MODULE( shift_line_bufferqcK )
{
    ...
    SC_CTOR( shift_line_bufferqcK ) {
        meminst = new shift_line_bufferqcK_core <DataWidth, AddressWidth, AddressRange>("core_inst");
    ...
    ~shift_line_bufferqcK() {
        delete meminst;
    }

public:
    shift_line_bufferqcK_core <DataWidth, AddressWidth, AddressRange>* meminst;

};

#endif //_shift_line_bufferqcK_H_
