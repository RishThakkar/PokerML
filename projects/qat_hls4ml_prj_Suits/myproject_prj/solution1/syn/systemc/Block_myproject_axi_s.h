...
#ifndef _Block_myproject_axi_s_HH_
#define _Block_myproject_axi_s_HH_
...
struct Block_myproject_axi_s : public sc_module {
    ...
    // Module declarations
    Block_myproject_axi_s(sc_module_name name);
    SC_HAS_PROCESS(Block_myproject_axi_s);
