...
struct dense_array_ap_fixed_24u_array_ap_fixed_16_6_5_3_0_42u_config15_s : public sc_module {
    ...
    sc_signal< sc_lv<16> > tmp_data_0_V_reg_3165;
    sc_signal< sc_logic > ap_CS_fsm_state10;
    sc_signal< sc_lv<16> > tmp_data_1_V_reg_3170;
    sc_signal< sc_lv<16> > tmp_data_2_V_reg_3175;
    sc_signal< sc_lv<16> > tmp_data_3_V_reg_3180;
    sc_signal< sc_lv<16> > tmp_data_4_V_reg_3185;
    sc_signal< sc_lv<16> > tmp_data_5_V_reg_3190;
    sc_signal< sc_lv<16> > tmp_data_6_V_reg_3195;
    sc_signal< sc_lv<16> > tmp_data_7_V_reg_3200;
    sc_signal< sc_lv<16> > tmp_data_8_V_reg_3205;
    sc_signal< sc_lv<16> > tmp_data_9_V_reg_3210;
    sc_signal< sc_lv<16> > tmp_data_10_V_reg_3215;
    sc_signal< sc_lv<16> > tmp_data_11_V_reg_3220;
    sc_signal< sc_lv<16> > tmp_data_12_V_reg_3225;
    sc_signal< sc_lv<16> > tmp_data_13_V_reg_3230;
    sc_signal< sc_lv<16> > tmp_data_14_V_reg_3235;
    sc_signal< sc_lv<16> > tmp_data_15_V_reg_3240;
    sc_signal< sc_lv<16> > tmp_data_16_V_reg_3245;
    sc_signal< sc_lv<16> > tmp_data_17_V_reg_3250;
    sc_signal< sc_lv<16> > tmp_data_18_V_reg_3255;
    sc_signal< sc_lv<16> > tmp_data_19_V_reg_3260;
    sc_signal< sc_lv<16> > tmp_data_20_V_reg_3265;
    sc_signal< sc_lv<16> > tmp_data_21_V_reg_3270;
    sc_signal< sc_lv<16> > tmp_data_22_V_reg_3275;
    sc_signal< sc_lv<16> > tmp_data_23_V_reg_3280;
    sc_signal< sc_lv<16> > tmp_data_24_V_reg_3285;
    sc_signal< sc_lv<16> > tmp_data_25_V_reg_3290;
    sc_signal< sc_lv<16> > tmp_data_26_V_reg_3295;
    sc_signal< sc_lv<16> > tmp_data_27_V_reg_3300;
    sc_signal< sc_lv<16> > tmp_data_28_V_reg_3305;
    sc_signal< sc_lv<16> > tmp_data_29_V_reg_3310;
    sc_signal< sc_lv<16> > tmp_data_30_V_reg_3315;
    sc_signal< sc_lv<16> > tmp_data_31_V_reg_3320;
    sc_signal< sc_lv<16> > tmp_data_32_V_reg_3325;
    sc_signal< sc_lv<16> > tmp_data_33_V_reg_3330;
    sc_signal< sc_lv<16> > tmp_data_34_V_reg_3335;
    sc_signal< sc_lv<16> > tmp_data_35_V_reg_3340;
    sc_signal< sc_lv<16> > tmp_data_36_V_reg_3345;
    sc_signal< sc_lv<16> > tmp_data_37_V_reg_3350;
    sc_signal< sc_lv<16> > tmp_data_38_V_reg_3355;
    sc_signal< sc_lv<16> > tmp_data_39_V_reg_3360;
    sc_signal< sc_lv<16> > tmp_data_40_V_reg_3365;
    sc_signal< sc_lv<16> > tmp_data_41_V_reg_3370;
    sc_signal< bool > ap_block_state1;
    sc_signal< bool > ap_block_pp0_stage0_subdone;
    sc_signal< sc_logic > ap_condition_pp0_exit_iter0_state2;
    sc_signal< sc_logic > grp_dense_wrapper_ap_fixed_16_6_5_3_0_ap_fixed_16_6_5_3_0_config15_s_fu_811_ap_start;
    sc_signal< sc_logic > grp_dense_wrapper_ap_fixed_16_6_5_3_0_ap_fixed_16_6_5_3_0_config15_s_fu_811_ap_done;
    sc_signal< sc_logic > grp_dense_wrapper_ap_fixed_16_6_5_3_0_ap_fixed_16_6_5_3_0_config15_s_fu_811_ap_idle;
    sc_signal< sc_logic > grp_dense_wrapper_ap_fixed_16_6_5_3_0_ap_fixed_16_6_5_3_0_config15_s_fu_811_ap_ready;
    ...
    sc_signal< sc_logic > grp_dense_wrapper_ap_fixed_16_6_5_3_0_ap_fixed_16_6_5_3_0_config15_s_fu_811_ap_start_reg;
    ...
    sc_signal< sc_logic > io_acc_block_signal_op584;
    ...
    void thread_grp_dense_wrapper_ap_fixed_16_6_5_3_0_ap_fixed_16_6_5_3_0_config15_s_fu_811_ap_start();
    void thread_i_in_fu_917_p2();
    void thread_icmp_ln36_fu_911_p2();
    void thread_internal_ap_ready();
    void thread_io_acc_block_signal_op221();
    void thread_io_acc_block_signal_op584();
