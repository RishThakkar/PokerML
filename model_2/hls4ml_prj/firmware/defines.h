...
typedef struct exponent_scale16_t {ap_uint<1> sign;ap_int<2> weight; } exponent_scale16_t;
...
typedef struct exponent_scale18_t {ap_uint<1> sign;ap_int<5> weight; } exponent_scale18_t;
...
typedef struct exponent_scale19_t {ap_uint<1> sign;ap_int<2> weight; } exponent_scale19_t;
typedef ap_fixed<6,1> bias19_t;
